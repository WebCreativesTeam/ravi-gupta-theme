...
?>
  ...
  <section class="py-10 bg-white sm:py-16 lg:py-24">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <h2 class="mb-20 text-3xl font-bold leading-tight text-center text-black sm:text-4xl lg:text-5xl">
        Join Our Community
      </h2>
      <div class="grid grid-cols-1 mx-auto mt-4 text-center sm:grid-cols-2 gap-y-6 lg:grid-cols-5 sm:gap-4">
        ...
        <div>
          <div class="flex items-center justify-center w-20 h-20 mx-auto bg-blue-100 rounded-full">
            <svg class="w-10 h-10 text-blue-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
